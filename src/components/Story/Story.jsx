...
import {selectSDImage, selectSDStatus, selectSDError} from "../../store/stablediffusionSlice";
...
console.log("ERROR 2", err);
  ...
  if (status === "succeeded" && image) {
    return (
      ...
      {image ? (<img src={`data:image/png;base64,${image}`} alt="Generated Story" />) : (<p>No Image Found</p>)}
      </div>
