...
import {
  fetchImage,
  selectSDStatus,
} from "../../store/stablediffusionSlice.js";
                ...
                <div>
                  <label htmlFor="gemini-api">
                    ...
                    <div id="iconDiv" style={{ position: "relative" }}>
                      ...
                      >
                        {showgeminiKey ? <HideIcon /> : <ShowIcon />}
                      </span>
                    </div>
